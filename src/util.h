...
namespace X {
    namespace Util{
        ...
        /*
         * Linear interpolation of domain. output(i) = (end - start) * i / (N-1), i = 0 ~ N-1
         */
         template <typename T, xsize N>
         void dLinspace1(Index1<T,N>&, T start, T end);
        
         /*
         * Linear interpolation of domain. output(i) = (end - start) * i / N, i = 0 ~ N-1
         */
         template <typename T, xsize N>
         void dLinspace2(Index1<T,N>&, T start, T end);
